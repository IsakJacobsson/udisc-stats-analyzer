...
```
PYTHONPATH=src python -m udisc_stats hole-distribution --csv-dir score_cards --course Vipan --layout 'New Main 2026'
```
...
```
PYTHONPATH=src python -m udisc_stats performance-curve --csv-dir score_cards --course Vipan --layout 'New Main 2026'
```
...
```
PYTHONPATH=src python -m udisc_stats score-distribution --course Vipan --layout 'New Main 2026' --csv-dir score_cards
```
...
```
PYTHONPATH=src python -m udisc_stats basic-stats --csv-dir score_cards --course Vipan --layout 'New Main 2026'
```
